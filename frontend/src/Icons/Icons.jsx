export const Icons = {
    eye_on: (
        <svg
            ...
            className="icon icon-tabler icons-tabler-outline icon-tabler-eye stroke-gray-500"
        >
    ...
    eye_off: (
        <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="icon icon-tabler icons-tabler-outline icon-tabler-eye-off stroke-gray-500"
        >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    income: (
        <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="icon icon-tabler icons-tabler-outline icon-tabler-moneybag-move-back"
        >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    expense: (
        <svg
            ...
            strokeLinecap="round"
            strokeLinejoin="round"
            className="icon icon-tabler icons-tabler-outline icon-tabler-moneybag-move"
        >
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <path d="M9.5 3h5a1.5 1.5 0 0 1 1.5 1.5a3.5 3.5 0 0 1 -3.5 3.5h-1a3.5 3.5 0 0 1 -3.5 -3.5a1.5 1.5 0 0 1 1.5 -1.5" />
